        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              <Button
                size="lg"
                className="h-[52px] btn-primary-gradient text-base px-8"
                asChild
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="h-[52px] border-primary text-primary hover:bg-primary hover:text-primary-foreground text-base"
                asChild
              >
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 bg-background rounded-2xl shadow-strong p-4 border border-border"
            >
